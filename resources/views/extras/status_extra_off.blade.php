    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Activar extras</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-check mr-2"></i>Activar Extras <span class="badge badge-danger animated shake">New</span></a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                    <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                        En esta pantalla podrás ver los extras desactivados o agotados
                        <p></p>
                        <p><b>Recuadro izquierdo:</b> Si deseas activar uno o más extras, deberás seleccionarlo(s) y dar clic sobre el botón <b><i>Agregar</i></b> y posteriormente clic en guardar para aplicar los cambios.</p>
                    
                        <p></p>
                        <p><b>Recuadro derecho:</b> De este lado podrás ver los extras que seleccionaste y agregaste para posteriormente activarlos. Si te equivocaste al agregar un extra al recuadro derecho, puedes seleccionarlo y dar clic en el botón <b><i>Quitar</i></b> para eliminar la selección de ese extra.</p>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('.duallistbox').bootstrapDualListbox({
        ...
        nonSelectedListLabel: 'Extras agotados o desactivados',
