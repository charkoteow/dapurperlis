  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-times mr-2"></i>Desactivar Extras <span class="badge badge-danger animated shake">New</span></a>
        </li>
        <li class="nav-item">
            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                  <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                    En esta pantalla podrás ver los extras activos o disponibles
                    <p></p>
                    <p><b>Recuadro izquierdo:</b> Si deseas desactivar/agotar uno o más extras, deberás seleccionarlo(s) y dar clic sobre el botón <b><i>Agregar</i></b> y posteriormente clic en guardar para aplicar los cambios.</p>
                    
                    <p></p>
                    <p><b>Recuadro derecho:</b> De este lado podrás ver los extras que seleccionaste y agregaste para posteriormente desactivarlos o ponerlos como agotados. Si te equivocaste al agregar un extra al recuadro derecho, puedes seleccionarlo y dar clic en el botón <b><i>Quitar</i></b> para eliminar la selección de ese extra.</p>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    $('.duallistbox').bootstrapDualListbox({
        ...
        nonSelectedListLabel: 'Extras activos',
