    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Desactivar Extras</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-usd mr-2"></i>Cambiar precios masivos <span class="badge badge-danger animated shake">New</span></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    {!! Form::label('price', trans("lang.extra_price"), ['class' => 'control-label text-right']) !!}
                    {!! Form::number('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.extra_price_placeholder"),'step'=>"any", 'min'=>"0", 'id' => 'price']) !!}
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                  <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                    En esta pantalla podrás ver los extras disponibles y agotados
                    <p></p>
                    <p><b>Recuadro izquierdo:</b> Si deseas modificar el precio de uno o más extras, deberás seleccionarlo(s) y dar clic sobre el botón <b><i>Agregar</i></b> y posteriormente clic en guardar para aplicar los cambios.</p>
                    
                    <p></p>
                    <p><b>Recuadro derecho:</b> De este lado podrás ver los extras que seleccionaste y agregaste para posteriormente cambiarles el precio. Si te equivocaste al agregar un extra al recuadro derecho, puedes seleccionarlo y dar clic en el botón <b><i>Quitar</i></b> para eliminar la selección de ese extra.</p>
                </div>
              </div>
...
<script type="text/javascript">
    ...
    $('.duallistbox').bootstrapDualListbox({
        infoTextFiltered:'<span class="badge badge-warning">Extras</span> {0} de {1}',
        infoText:'Mostrar todos {0}',
        infoTextEmpty:'Lista vacía',   
        filterTextClear:'mostrar todos',
        filterPlaceHolder:'Buscar extras...',
        moveSelectedLabel:'Mover seleccionados',
        moveAllLabel:'Mover todos',
        removeSelectedLabel:'Remover seleccionados',
        removeAllLabel:'Remover todos',
        nonSelectedListLabel: 'Todos los extras',
    ...
    $("body").on("click", ".action", function( event ) {
        ...
        $.ajax({
            url: "{{ route('extra.changepricemasive') }}",
            type: 'POST',
            data: {
                _token: CSRF_TOKEN,
                extra: $("#id_foods").val(),
