    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Activar productos</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-check mr-2"></i>Activar Productos <span class="badge badge-danger animated shake">New</span></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="custom-content-above-tabContent">
                    <div class="tab-pane fade show active" id="custom-content-above-home" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
                        En esta pantalla podrás ver los productos desactivados o agotados
                        <p></p>
                        <p><b>Recuadro izquierdo:</b> Si deseas activar uno o más productos, deberás seleccionarlo(s) y dar clic sobre el botón <b><i>Agregar</i></b> y posteriormente clic en guardar para aplicar los cambios.</p>
                    
                        <p></p>
                        <p><b>Recuadro derecho:</b> De este lado podrás ver los productos que seleccionaste y agregaste para posteriormente activarlos. Si te equivocaste al agregar un producto al recuadro derecho, puedes seleccionarlo y dar clic en el botón <b><i>Quitar</i></b> para eliminar la selección de ese producto.</p>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $('.duallistbox').bootstrapDualListbox({
        ...
        nonSelectedListLabel: 'Productos agotados o desactivados',
